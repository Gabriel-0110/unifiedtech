      ...
      <form onSubmit={handleSubmit} className='space-y-6'>
        ...
        <div className='grid grid-cols-1 gap-6 sm:grid-cols-2'>
          ...
          <div>
            ...
            <input name='phone' value={formData.phone} onChange={handleChange} placeholder='+1 (555) 123-4567' className='w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100' />
          </div>
        </div>
        <div>
